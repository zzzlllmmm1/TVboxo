var rule = {
	title: '优秀[V2]', // csp_AppYsV2
	host: 'https://www.gvideo.me/',
	...
	timeout: 5000,
	class_name: '电视剧&电影&动漫&电影[4K]&电视剧[4K]', // 分类筛选 /api.php/app/nav
	class_url: '2&1&4&6&7',
	play_parse: true,
	//http://svip.realdou.cn/home/api?type=ys&uid=1879248&key=kmnopruvxzILPQRS78&url=
	lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://svip.realdou.cn/home/api?type=ys&uid=1738434&key=abfhlvwyAIJLOW1457&url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
	limit: 6,
