var rule = {
  ...
  //host: 'https://site.ip138.com/45.85.76.17',
	...
	play_parse:true,
	lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://bingfa.behds.cn/indexappzhuanyong.php?url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
	limit:6,
