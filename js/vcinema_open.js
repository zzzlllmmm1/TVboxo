...
let deviceId = '660dfa76f-9db334-ef1c';
...
async function request(reqUrl, post, param) {
    ...
    uri.addQueryParam('app_version', '2.8.1');
...
async function init(cfg) {
    siteKey = cfg.skey;
    siteType = cfg.stype;
    const html = (await req(baseUrl + '/play', {
        headers: {
...
async function play(flag, id, flags) {
    ...
    let data = JSON.parse(await request(`/movie/get_pc_movie_url_v2/${voId}`)).content;
