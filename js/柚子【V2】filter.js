var rule = {
	title: '柚子[V2]', // csp_AppYsV2
	host: 'http://111.173.89.201:1314',
	...
	timeout: 5000,
	class_name: '电影&连续剧&港台剧&欧美剧&日韩剧&动漫&综艺&哔哩&短剧&直播', // 分类筛选 /api.php/app/nav
	class_url: '1&2&3&4&5&29&30&31&34&35',
	play_parse: true,
	lazy: 'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://111.173.89.201:1314/json/json.php?url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
	limit: 6,
