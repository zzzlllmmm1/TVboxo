...
let cookie = 'DedeUserID=690781341;DedeUserID__ckMd5=cabc96906269c5b6;SESSDATA=2245ba24%2C1684212125%2C466fd%2Ab2;bili_jct=de6fdb60c10f8a83910aa55d79407b4e;';
let login = '';
let vip = false;
let extendObj = {};
let bili_jct = '';
...
async function init(cfg) {
    ...
    if (typeof cfg.ext == 'string' && cfg.ext.indexOf('http') == 0) {
    ...
    if (cfg.ext.hasOwnProperty('categories'))
        ...
        extend = '小白评测#渤海小吏#大喜唠嗑家#解说#一口气#韩剧#日剧#美剧#英剧#电影#电视剧#历史#小说#科学透镜#沙雕#沙雕穿越#沙雕动漫#抖音热歌#经典无损音乐合集#超清MV';
    ...
    // newarr.push(sc);
    for (const kk of ext) {
        const kkk = kk.indexOf('$') > 0 ? kk : kk + "$" + kk;
        const c = {
            type_name: kkk.split('$')[0],
            type_id: kkk.split('$')[1],
            land: 1,
            ratio: 1.33,
            type_flag: '0-0-H'
